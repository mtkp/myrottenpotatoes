...
ActiveRecord::Schema.define(version: 20130821193758) do
  ...
  add_index "moviegoers", ["name", "uid", "provider"], name: "index_moviegoers_on_name_and_uid_and_provider", using: :btree
